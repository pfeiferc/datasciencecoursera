...
The objective of the app is to let the user explore the geographic pattern of livestock ownership accross Africa. But geographical data is very heavy to host, so the app did not run on R-Shinys so i restricted it to few countries only (Kenya, Ethiopia and Uganda). 
...
The variable always shows the proportion of household keeping the selected type of livestock at the DHS cluster level (group of about 30 households that get a similar gps coordinates in order to make surveys anonymous).
...
5. pitch.rmd the code behind the pitch that is also found on Rpubs http://rpubs.com/pfeiferc/pitch_shiny 
